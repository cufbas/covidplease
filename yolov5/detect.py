...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        center = center_of_rect(xyxy)
                        print(center[0])
                        r.main_movement(trackable=center[0])
                        #  I'm turning off the plotting here as well to improve performance, hopefully.
            ...
            # Stream results
            if view_img:
                #  I've turned off the live view, as it might improve performance.
                cv2.imshow(p, im0)
